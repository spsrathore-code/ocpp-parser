...
| 2 | **Parser — revamp** (TS+Vite) | 🟡 In build (Phase 3 + 4a/4b/4d + 6 + §4 compliance done; 3b-3b/4c/4e parked) | Build→Review | `feat/parser-revamp` | `/review`+`/qa` Phase 6 + §4 compliance, then deploy decision (Help modal + parked items) |
