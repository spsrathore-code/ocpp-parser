...
| 2 | **Parser — revamp** (TS+Vite) | 🟡 In build (Phase 3b: 19/19 sections + context-viewer) | Build | `feat/parser-revamp` | 3b-3b RemoteStart diagnostic; then 3c charts, 3d export |
