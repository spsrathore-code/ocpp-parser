...
| 2 | **Parser — revamp** (TS+Vite) | 🟡 In build (Phase 3b-3a of 6 done) | Build | `feat/parser-revamp` | Phase 3b-3b — Repeated-RemoteStart diagnostic |
...
- [~] **Phase 3 — Render/UI** (19 sections, charts, export, theme) — sub-phased; spec `docs/superpowers/specs/2026-06-15-parser-phase3-render-design.md`.
  ...
  - [~] 3b Static section renderers (batched, 6/19 done): [x] 3b-1 generic `dataTable` + Heartbeats/Start/Stop · [x] 3b-2 Debug Info + Boot · [x] 3b-3a Status table+distribution+flow+errors (92 tests) · [ ] 3b-3b RemoteStart diagnostic · [ ] 3b-4 tx-centric · [ ] 3b-5 analysis · [ ] context-viewer (Preview/Download).
