...
| 2 | **Parser — revamp** (TS+Vite) | 🟡 In build (Phase 3a of 6 done) | Build | `feat/parser-revamp` | Phase 3b — real section renderers (replace placeholders) |
...
- [~] **Phase 3 — Render/UI** (19 sections, charts, export, theme) — sub-phased; spec `docs/superpowers/specs/2026-06-15-parser-phase3-render-design.md`.
  ...
  - [ ] 3b Static section renderers · [ ] 3c Charts (Chart.js) · [ ] 3d Excel export (SheetJS).
