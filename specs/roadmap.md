...
| 2 | **Parser — revamp** (TS+Vite) | 🟡 In build (Phase 3 + 4a + 4b + 4d done; 3b-3b + 4c + 4e parked) | Build | `feat/parser-revamp` | Phase 5 — parity gate (deploy swap held until parked items resolved/approved) |
