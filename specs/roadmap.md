...
| 2 | **Parser — revamp** (TS+Vite) | 🟡 In build (Phase 3b: 11/19 sections) | Build | `feat/parser-revamp` | Phase 3b-5 — analysis section renderers |
...
- [~] **Phase 3 — Render/UI** (19 sections, charts, export, theme) — sub-phased; spec `docs/superpowers/specs/2026-06-15-parser-phase3-render-design.md`.
  ...
  - [~] 3b Static section renderers (batched, 11/19 done): [x] 3b-1 `dataTable` + Heartbeats/Start/Stop · [x] 3b-2 Debug Info + Boot · [x] 3b-3a Status · [x] 3b-4 tx-centric (Connector Stats, Transaction Summary, Events, Alerts, Meter Values; 108 tests) · [ ] 3b-3b RemoteStart diagnostic · [ ] 3b-5 analysis (8 sections) · [ ] context-viewer.
