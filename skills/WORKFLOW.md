...
- **3b static renders COMPLETE.** Remaining for Phase 3b parity: **3b-3b** Repeated-RemoteStart diagnostic + **context-viewer** (Preview/Download). Deferred to later sub-phases: 3c charts, 3d Excel export, and the chart/stats-coupled bits in Transaction Summary / Meter Values / Status.
